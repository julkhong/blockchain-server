...
//			}
//			sendErr := amountTransferContract.SendM(ctx, tt.senderID, tt.receiverID, tt.amount)
//			switch {
//			case tt.ctxErr:
...
//				ctx.Stub = &MockStub{StateMap: make(map[string][]byte)}
//			}
//			getBalanceRes, getBalanceErr := amountTransferContract.GetBalanceM(ctx, tt.accountID)
//			switch {
//			case tt.ctxErr:
