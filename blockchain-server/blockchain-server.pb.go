...
// source: blockchain-server-temp.proto
...
func init() {
	proto.RegisterType((*EchoRequest)(nil), "blockchain-server.EchoRequest")
	proto.RegisterType((*EchoResponse)(nil), "blockchain-server.EchoResponse")
	proto.RegisterType((*Parameters)(nil), "blockchain-server.Parameters")
	proto.RegisterType((*ChainCodeRequest)(nil), "blockchain-server.ChainCodeRequest")
	proto.RegisterType((*ChainCodeResponse)(nil), "blockchain-server.ChainCodeResponse")
}

func init() { proto.RegisterFile("blockchain-server-temp.proto", fileDescriptor_6d6c9083788a8f1d) }
...
func (c *blockchainClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blockchain-server.Blockchain/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blockchainClient) Send(ctx context.Context, in *ChainCodeRequest, opts ...grpc.CallOption) (*ChainCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blockchain-server.Blockchain/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blockchainClient) Balance(ctx context.Context, in *ChainCodeRequest, opts ...grpc.CallOption) (*ChainCodeResponse, error) {
	out := new(ChainCodeResponse)
	err := c.cc.Invoke(ctx, "/blockchain-server.Blockchain/Balance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Blockchain_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockchain-server.Blockchain/Echo",
	}
...
func _Blockchain_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockchain-server.Blockchain/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Blockchain_Balance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blockchain-server.Blockchain/Balance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Blockchain_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blockchain-server.Blockchain",
	...
	Metadata: "blockchain-server-temp.proto",
}
